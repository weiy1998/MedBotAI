...
#######################################################################
# Model
pretrained_model_name_or_path = '/MedBotAI/models/qwen/Qwen2.5-7B-Instruct'   # 设置LLM路径或huggingface hub id
use_varlen_attn = False

# Data
alpaca_en_path = '/MedBotAI/datasets/med_data_multi_round_QA_lora.json'     # 微调数据路径HuggingFace Hub ID，以用于 datasets.load_dataset
...
evaluation_inputs = [
    '我有点腰酸背痛', 'a little sore in the lower back and back pain.',
    '头疼了怎们办？', 'What should i do if i have a headache?'
]
